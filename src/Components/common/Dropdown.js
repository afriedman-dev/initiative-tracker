...
const Dropdown = ({ data }) => {
   ...
   const statusOptionsToggle = () => {
      ...
      statusList.style.display =
         statusList.style.display == 'none' ? 'block' : 'none';
   };
      ...
      <div className="col-auto my-1">
         <div className="card">
            <div
               ...
               onClick={statusOptionsToggle}
               style={{ cursor: 'pointer' }}>
               <h5>
                  Status{' '}
                  <i id="collapse-carrot" className="fas float-right my-auto" />
               </h5>
            </div>
            <ul
                  ...
                  {data.options.map(option => {
                     return (
                        <a href="#" key={option}>
                           <i
                              className={
                                 'status-icons m-1 fa ' + statusDict[option]
                              }
                           />
                        </a>
                     );
